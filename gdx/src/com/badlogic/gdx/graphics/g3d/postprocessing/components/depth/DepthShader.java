...
public class DepthShader extends DefaultShader {
	...
	public final static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("com/badlogic/gdx/graphics/g3d/postprocessing/components/depth/depth.vertex.glsl").readString();
	...
	public final static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("com/badlogic/gdx/graphics/g3d/postprocessing/components/depth/depth.fragment.glsl").readString();
